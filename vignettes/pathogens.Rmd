...
```{r, fig.height = 7, fig.width = 7, fig.cap = 'Exceedances of *Enterococcus* concentrations at Peconic Estuary bathing beaches for the years 2010 through 2021.  Values are number of samples exceeding.'}
...
```{r, fig.height = 7, fig.width = 7, fig.cap = 'Exceedances of *Enterococcus* concentrations at Peconic Estuary bathing beaches for the years 2010 through 2021.  A different option is used for the threshold argument.'}
...
show_entmatrix(entdat, txtsz = NULL) +
  scale_x_discrete(expand = c(0,0), breaks = c(2000:2021)) + 
  coord_flip() +
