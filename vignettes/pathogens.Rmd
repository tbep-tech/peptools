...
```{r, fig.height = 7, fig.width = 7, fig.cap = 'Frequencies of exceedances of *Enterococcus* concentrations at Peconic Estuary bathing beaches for the years 2010 through 2020.'}
