...
```{r}
mosum <- anlz_domopep(dodat, thr = 2.3)
mosum
```
...
The summarized monthly data can be plotted with the `show_domatrix()` function. In this example, the default plot shows the proportion of days in a month when concentrations in a given day fell below a threshold of 2.3 mg/L. 
