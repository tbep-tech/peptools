...
Total nitrogen can also be plotted.  A threshold line is not displayed because there are no targets available in the package. 

```{r, fig.height = 5, fig.width = 8}
show_thrpep(dat, bay_segment = "Western", param = "tn")
```
