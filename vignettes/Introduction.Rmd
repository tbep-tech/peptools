...
```{r, fig.height = 5, fig.width = 8}
show_thrpep(dat, bay_segment = "Western", param = "chla", yrrng = c(1988, 2019))
```
...
newthr <- show_matrixpep(dat, trgs = newtrgs, yrrng = c(1989, 2019))
newthr
```
...
oldthr <- show_matrixpep(dat, yrrng = c(1989, 2019))
