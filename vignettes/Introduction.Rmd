...
<figure>
  <img src="outints.png" style="width:80%">
  <figcaption>Outcomes for annual estimates of water quality are assigned an integer value from zero to three depending on both magnitude and duration of the exceedence.</figcaption>
</figure>
...
<figure>
  <img src="matrixcats.png" style="width:80%">
  <figcaption>Management action categories assigned to each bay segment and year based on chlorophyll and secchi depth outcomes.</figcaption>
</figure>
