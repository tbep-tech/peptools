#' @title Plot monthly chlorophyll or secchi values values for a segment
#'
#' @description Plot monthly chlorophyll or secchi values values for a bay segment
#'
#' @param dat data frame of data returned by \code{\link{read_pepwq}}
#' @param param chr string for which parameter to plot, one of \code{"chla"} for chlorophyll or \code{"sd"} for secchi depth
